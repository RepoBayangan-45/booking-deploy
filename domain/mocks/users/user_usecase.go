...
import (
	...
	request "Office-Booking/domain/users/request"

	mock "github.com/stretchr/testify/mock"

	response "Office-Booking/domain/users/response"
)
...
// ReadByName provides a mock function with given fields: id
...
// ReadByID provides a mock function with given fields: name
func (_m *UserUsecase) ReadByName(name string) (*domain.User, error) {
	ret := _m.Called(name)
